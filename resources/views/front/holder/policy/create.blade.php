...
<section class="center">
    <div class="container">
        <h1>নতুন সদস্য যুক্ত করুন</h1>
        <form id="holder_form" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="input-area">
                <label for="full_name">সদস্যের পুরো নাম</label>
                <input id="full_name" name="name" type="text" placeholder="সদস্যের পুরো নাম">
            </div>
            <div class="input-area">
                <label for="address">সদস্যের ঠিকানা</label>
                <textarea name="address" name="address" id="address" placeholder="সদস্যের ঠিকানা"></textarea>
            </div>
            <div class="input-area">
                <label for="text">সদস্যের পলিসি নং</label>
                <input id="text" name="policy" type="text" placeholder="সদস্যের পলিসি নং">
            </div>
            <div class="input-area">
                <label for="mobile">সদস্যের মোবাইল নং</label>
                <input id="mobile" name="phone" type="text" placeholder="সদস্যের মোবাইল নং">
            </div>
            <div class="input-area">
                <label for="id_card">সদস্যের আই ডি কার্ড নং</label>
                <input id="id_card" name="id_card" type="number" placeholder="সদস্যের আই ডি কার্ড নং">
            </div>
            <div class="input-area">
                <label for="balance">সদস্যের বর্তমান ব্যালেন্স</label>
                <input id="balance" name="balance" type="number" placeholder="সদস্যের বর্তমান ব্যালেন্স">
            </div>
            <div class="join-date">
            ...
            <div class="image-upload">
                <div class="img">
                    <img id="output" src="{{ asset('front/images/profile.jpg') }}" alt="img">
                </div>
                <div class="content">
            ...
            <div class="btn-area text-start">
                <button id="add-btn" class="btn-primary btn" type="submit">সদস্য যুক্ত করুন</button>
            </div>
        </form>
    </div>
</section>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="text-center">
              <h3>নতুন সদস্য অন্তর্ভুক্ত হয়েছে</h3>
