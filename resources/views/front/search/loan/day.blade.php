...
<section class="center add-money">
    <div class="container">
        <div class="profile">
            <div class="title">
                <h1 class="m-0">দৈনিক ঋণ প্রদানের তালিকা</h1>
                ...
                <br>
                <br>
                <a href="{{ route('pdf.by.day', ['loan', $day, $month, $year]) }}" target="_blank" class="btn btn-primary">পি ডি এফ ডাউনলোড</a>
                <br>
                <br>
            </div>
        </div>
            ...
            <table class="table table-striped table-bordered custom-width">
                <thead>
                    <tr>
                      ...
                      <th scope="col">নাম</th>
                      <th scope="col">ঋণ প্রদানের পরিমাণ</th>
